    ...
    const displaySteps = newStep.map((step, index) =>{
        return(
            ...
            <div className='relative flex flex-col items-center text-teal-600'>
                ...
                border-2 border-gray-300 h-12 w-12 flex items-center justify-center py-3 ${step.seleted ? "bg-green-600 text-white font-bold border border-green-600" : ""}`}>
                    {/*Display Number */}
                    {step.completed ? (
